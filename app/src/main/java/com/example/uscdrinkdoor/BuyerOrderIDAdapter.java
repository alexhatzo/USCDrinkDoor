...
public class BuyerOrderIDAdapter extends ArrayAdapter<String> {
    ...
    private BuyerOrderClickListener clickListener;

    public BuyerOrderIDAdapter(@NonNull Context context, int resource, @NonNull ArrayList<String> objects) {
        super(context, resource, objects);
        this.mContext = context;
        this.mResource = resource;
        this.clickListener = (BuyerOrderClickListener) context;
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
                            if( task.getResult().get("Current") != null){
                                if (!(Boolean)task.getResult().get("Current")){
    ...
    public interface BuyerOrderClickListener {
